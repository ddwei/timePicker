package com.div.timepicker.datepicker;
...
import com.div.timepicker.R;
import com.div.timepicker.datepicker.DateFormatUtils;
import com.div.timepicker.datepicker.PickerView;
...
public class CustomTimePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private boolean isBeginTimeToToday = false;
    ...
    private void initView() {
        ...
        mPickerDialog.findViewById(R.id.tv_today).setOnClickListener(this);
        ...
        tvTimePickerTitle = mPickerDialog.findViewById(R.id.tv_time_picker_title);
    }

    public void setTimePickerTitle(String title) {
        tvTimePickerTitle.setText(title);
    }
    ...
    public void setBeginTimeToToday(boolean isBeginTimeToToday) {
        this.isBeginTimeToToday = isBeginTimeToToday;
    }

    public void invalidate() {
        if (isBeginTimeToToday) {
            initData(true);
        }else {
            setSelectedTime(System.currentTimeMillis(), true);
        }
    }
...
//                mTvTitle.setText(mBeginYear + "年" +mBeginMonth +  "月" + mBeginDay + "日" + " 星期" + DateUtils.getDayOfWeek(mSelectedTime));
    ...
    private void initData(boolean isBeginTimeToToday) {
        if (isBeginTimeToToday) {
            mBeginTime.setTimeInMillis(System.currentTimeMillis());
        }
...
//        mTvTitle.setText(mBeginYear + "年" +mBeginMonth +  "月" + mBeginDay + "日" + " 星期" + DateUtils.getDayOfWeek());
